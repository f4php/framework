...
final class DBTest extends TestCase
{
    ...
    public function testInsert(): void
    {
        ...
        $this->assertSame('INSERT INTO "table1" AS "t1" VALUES "fieldA" = $1, "fieldB" = $2, "fieldC" = $3 WHERE "fieldD" = $4 AND "fieldE" > $5 ON CONFLICT ("fieldF") DO UPDATE SET "fieldG" = $6 RETURNING "fieldH"', $db1->getPreparedStatement()->query);
        ...
        $db1 = DB::insert()->into('table1 t1')->values(['fieldA'=>1])->onConflict('fieldF')->doNothing();
        $this->assertSame('INSERT INTO "table1" AS "t1" VALUES "fieldA" = $1 ON CONFLICT ("fieldF") DO NOTHING', $db1->getPreparedStatement()->query);
    }
